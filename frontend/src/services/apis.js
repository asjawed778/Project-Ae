...
export const addCourseEndpoints = {
    ...
    EDIT_CATEGORY:(categoryId) => SERVER_URL + `/course/edit-category/${categoryId}` ,
    ...
    GET_FULL_COURSE_DETAILS:(courseId) => SERVER_URL + `/course/get-full-course-details/${courseId}` ,
