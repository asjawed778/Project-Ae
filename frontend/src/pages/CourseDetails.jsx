...
//   </div>
// <div class='main1'>
//   <div className="mt-10 max-w-5xl mx-auto flex gap-10 mb-10">
    
//     <div className="w-[670px]">  
//       <div class ='bm'>
// <div class='b1'>
//   <button  onClick={handleOverviewClick}>Overview</button></div>
// <div class='b3'>  <button onClick={handleCurriculumClick}>Curriculum</button>
//   </div>
//   </div>
//   {showOverview ? (
//       <div class='main'>
//     <h1 className="font-bold pt-4 pb-2">Explore Our Immersive {title} Bootcamp</h1>
//     {/* <p>{courseDesciption}</p> */}
//     <div
//      dangerouslySetInnerHTML={{ __html: courseDesciption }}
//     />
//     <p className="font-bold text-blue-500 pt-3.5">Read More</p>
//     </div>
//  ) : (
//   <div class ="book">
//     <div >
// {/*<LessonsComponent courseContent={courseContent} />*/}\
//    <LessonsComponent courseContent={courseContent} />
...
//   </div>
//   <div class='slot'>
//     <div className="p-5 space-y-4 flex-col border-[2px] shadow-lg w-{150px} ml-10">
...
const CourseDetails = () => { 
  ...
  //console.log(courseDesciption.toString()) ;
  const keyPoints = courseDetail?.courseDetails.course?.keyPoints ;
  const courseContent = courseDetail?.courseDetails?.course?.courseContent;
