...
//     >
//       <div
//         className="bg-transparent p-6 rounded-lg shadow-lg h-72 w-96 relative"
//         onClick={(e) => e.stopPropagation()} // Prevent closing when clicking inside the modal
//       >
//         <button
//           className="absolute top-2 right-2 text-gray-600 hover:text-gray-900"
...
//         <form className="space-y-4" onSubmit={resetPasswordSubmitHandler}>
//           <div>
//            <div> <label className="text-sm font-semibold">Lost your password? Please enter your email address. You will receive a link  via email.</label></div>
//           <label className="text-xs font-semibold text-gray-700 mt-2 ">Enter Your Email</label>
//             <input
//               type="email"
...
//           <button
//             className={`w-48 p-3 mt-3 rounded-md text-white ${
//               isFormValid
//                 ? "bg-blue-600 hover:bg-blue-700"
//                 : "bg-gray-400 cursor-not-allowed"
//             }`}
