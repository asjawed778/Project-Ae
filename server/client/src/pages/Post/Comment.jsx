...
const CommentSection = ({ comments, postId }) => {
  ...
  return (
    <div
      className="comment-section border border-gray-700 p-4 w-[700px] mx-auto mr-4"
      style={{
        borderColor: "#D8D8D8",
        borderWidth: "0.1px",
        borderBottom: "none",
...
const Comment = ({
  ...
  const handleEditReplySubmit = (replyId) => {
    dispatch(
      editReply(postId, comment._id, replyId, editedReplyText, user.username)
    );
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-grow">
          ...
          {isEditingComment === comment.user.id ? (
            <form
              onSubmit={() => handleEditCommentSubmit(user._id)}
              className="mt-2"
            >
              <input
                type="text"
